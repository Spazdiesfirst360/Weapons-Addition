...
function init()
  ...
  self.vaultAccessConfig = root.assetJson("/interface/scripted/simulationconsole_pastaccess/wa_simulationconsole_pastaccessgui.config")
...
function onInteraction()
  if self.isOutpostGate then
    ...
    if not storage.vaultActive then
      return { "ScriptPane", "/interface/scripted/simulationconsole_past/wa_simulationconsole_pastgui.config" }
    else
